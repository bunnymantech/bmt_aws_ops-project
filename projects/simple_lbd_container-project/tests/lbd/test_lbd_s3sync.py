...
from simple_lbd_container.lbd.s3sync import low_level_api
from simple_lbd_container.tests.mock import BaseMockTest
...
if __name__ == "__main__":
    ...
    run_cov_test(__file__, "simple_lbd_container.lbd.s3sync", preview=False)
