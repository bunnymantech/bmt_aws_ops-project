...
class StackExports:
    ...
    .. code-block:: python
        ...
        >>> stack_exports.get_iam_role_for_glue_arn()
    ...
    # --------------------------------------------------------------------------
    def get_iam_role_for_glue_arn(self) -> str:
        # use output key
        # return self._outputs["IamRoleForGlueArn"]
        # use export name
        return self._exports[f"{self.prefix_name_slug}-glue-role-arn"]
