...
from .sfn_statemachine import StateMachine, StateMachineMixin
...
class Env(
    ...
    def from_dict(cls, data: dict):
        ...
        data["state_machines"] = {
            ...
            for name, dct in data.get("state_machines", {}).items()
        }
        env = cls(**data)
        for sfn_state_machine in env.state_machines.values():
            sfn_state_machine.env = env
